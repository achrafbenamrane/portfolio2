...
export default function HeroCanvas() {
  ...
  return (
    <div className="pointer-events-none relative order-2 -mx-6 h-[34vh] min-h-52 w-full md:-mx-12 lg:absolute lg:inset-y-0 lg:right-0 lg:order-none lg:mx-0 lg:h-auto lg:w-[56%]">
